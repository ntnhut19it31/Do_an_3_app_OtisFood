...
import com.example.hoky.foodtea1.adapter.TrasuaAdapter;
...
public class TraSuaActivity extends AppCompatActivity {
    ...
    private void LoadMoreData() {
        ...
        lvts.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra("thongtinsanpham",mangts.get(position));
                startActivity(intent);
            }
        });
        lvts.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongdan, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (response != null && response.length() != 2){
                        lvts.removeFooterView(footerview);
                    try {
                        ...
                        for (int i = 0; i< jsonArray.length();i++){
                            ...
                            mangts.add(new Sanpham(id,Tents,Giats,Hinhanhts,Mota,Idspts));
    ...
    private void Anhxa() {
        toolbar = findViewById(R.id.toolbartrasua);
        lvts = findViewById(R.id.listviewtrasua);
        mangts = new ArrayList<>();
        trasuaAdapter = new TrasuaAdapter(getApplicationContext(),mangts);
        lvts.setAdapter(trasuaAdapter);
